...
const skill1 = {
    ...
    technique: "C#",
    description:
        "I have experienced C# for 3 years at an IT company in Japan. I developed large scale application.",
    image: CIcon,
    imageLabel: "c#-icon",
    years: "3",
    level: "middle",
    ...
    projects: [
        {
            ...
            description:
                "This is a game application. I developed it by C#. I used object oriented design to develop. It is easy to add new games.",
            image: ticTacIcon,
        },
    ],
};
...
const skill2 = {
    ...
    description:
        "I develop blockchain applications using typescript and Node.js.",
    ...
    projects: [
        {
            ...
            description:
                "This is a knowledge database application. I developed it by typescript and Next.js.",
            image: blogIcon,
        },
        {
            id: 7,
            ...
            repository:
                "https://github.com/takaomizuno0032/blockchain_news_bot",
            description:
                "This is a line bot which can send blockchain news. I developed it by javascript and lineapi.",
            image: lineBotIcon,
        },
    ],
};
...
const skill3 = {
    ...
    technique: "Python",
    description:
        "I write scripts by python to make my life be more convenient. In addition, I solve some algorithm problems by python.",
    image: PythonIcon,
    ...
    projects: [
        {
            ...
            description:
                "This is a keyboard ecommerce application. I developed it by python and Flask.",
            image: keyBoardIcon,
        },
        {
            id: 4,
            ...
            description:
                "This is a discord bot application which is a product in QUT code network. I developed it by python and discord.py.",
            image: discordIcon,
        },
    ],
};
...
const skill4 = {
    ...
    technique: "IOTA",
    description:
        "This is the blockchain network I am most interested in. I believe it will be the foundation for changing smart cities.",
    image: IotaIcon,
...
const skill6 = {
    ...
    technique: "React",
    description:
        "This site is created by React and Material UI. I can use Next.js, as well.",
    image: ReactIcon,
    ...
    projects: [
        {
            ...
            description:
                "This is my introduction site. I developed it by React and Material UI.",
            image: heroIcon,
        },
    ],
};
